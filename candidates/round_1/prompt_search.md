...
5. **Write the candidate file** to `/local/home/cyanz/wave_PINN/candidates/round_1/candidate.py`. The file must define:
...
6. **Write a reasoning log** to `/local/home/cyanz/wave_PINN/candidates/round_1/candidate_log.md` explaining:
