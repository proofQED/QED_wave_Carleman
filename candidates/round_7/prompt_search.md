...
3. **Read the previous round's verification report** at `/local/home/cyanz/wave_PINN/candidates/round_6/verification_report.md` to understand which conditions failed and the diagnostic expressions.
...
5. **Write the candidate file** to `/local/home/cyanz/wave_PINN/candidates/round_7/candidate.py`. The file must define:
...
6. **Write a reasoning log** to `/local/home/cyanz/wave_PINN/candidates/round_7/candidate_log.md` explaining:
